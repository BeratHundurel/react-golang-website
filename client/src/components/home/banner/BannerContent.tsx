   ...
   return (
      <div className="bg-secondary py-12 px-12 w-full flex flex-col items-start gap-5">
         <div className="w-8/12">
            <p className="text-neutra text-base font-semibold mb-5">New Arrival</p>
         ...
         <button className="w-1/3 py-4 px-3 flex justify-center items-center bg-primary font-semibold">
